...
export function connect<T extends Record<string, any>, P extends Record<string, any>>
  (Component: typeof Block<T>, mapStateToProps: (state: State) => P): typeof Block<Omit<T, keyof P>> {
    ...
    super({...props, ...currentState});
      ...
      store.on(StoreEvents.Updated, () => {
        ...
        if (!isEqual(currentState, newState)) {
          ...
          console.log(JSON.parse(JSON.stringify(currentState)))

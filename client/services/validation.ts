...
export const ValidationInfo = {
  ...
  [ValidationTypes.NAME]: {
    ...
    error: 'Name must begin with a capital letter without numbers or special symbols'
  },
  ...
  [ValidationTypes.PASSWORD]: {
    regexp: /^(?=.*[A-Z])(?=.*[0-9])(.{8,40})$/,
    error: 'Password must contains between 8 and 40 letters with atleast 1 capital letter and 1 number'
  },
